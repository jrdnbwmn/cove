...
export default class extends Controller {
  ...
  connect() {
    this.tooltipContent = this.element.getAttribute("data-ui-tooltip-content") || "";
    this.showArrow = this.element.getAttribute("data-ui-tooltip-arrow") !== "false";
    ...
    this.tooltipElement.className =
      "tooltip-content pointer-events-none wrap-break-word shadow-sm border rounded-lg border-white/10 fixed bg-neutral-800 text-white py-1 px-2 z-[1000]";
    ...
    if (this.showArrow) {
      ...
      this.arrowElement.className = "tooltip-arrow-element bg-neutral-800 w-2 h-2 border-white/10";
  ...
  _renderTooltipContent() {
    ...
    contentElement.textContent = this.tooltipContent;
